 ...
 (function($) {
    $.imageArea = function(parent, id) {
        ...
        var options = parent.options,
            ...
            updateSelection = function (visible) {
                // Update the outline layer
                console.log("jj",visible);
                if(visible == true){
                    $outline.css({
                        cursor: "default",
                        width: area.width,
            ...
            updateLblInfo = function (visible) {
              if ($lblinfo) {
                ...
                //   "z-index": area.z + 200,
                  ...
                  var node = $("<select>").appendTo($lblinfo1);
                ...
                //   $lblinfo.append($("<br/>"));
                  var infoText = $("<span>").text("ID" + ":" + Math.round(area.id) + "," + "H" + ":" + Math.round(area.height) + "," + "W" + ":"+ Math.round(area.width));
        ...
        $lblinfo1  = $("<div class=\"info-area1\"></div>").insertAfter($selection);
